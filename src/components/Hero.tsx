...
function getBotColors() {
  ...
  return {
    gold: s.getPropertyValue("--color-accent-500").trim() || "#FFFFFF",
    lightGold: s.getPropertyValue("--color-accent-400").trim() || "#E0E0E2",
    warmGold: s.getPropertyValue("--color-accent-300").trim() || "#A8A8AC",
    muted: "#A1A1AA",
    dim: "#71717A",
  };
}
